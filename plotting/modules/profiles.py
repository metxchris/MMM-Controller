    ...
    * scan_factor (float): The value of the scan factor (Optional)
    ...
    if profile_type == ProfileType.INPUT:
        plotdata = [
            ...
            PlotData(vars.bu.name, vars.rho, [vars.bu]),
            ...
            PlotData(vars.az.name, vars.rho, [vars.az]),
            PlotData(vars.ai.name, vars.rho, [vars.ai]),
            PlotData(vars.ah.name, vars.rho, [vars.ah]),
            PlotData(vars.zz.name, vars.rho, [vars.zz]),
            PlotData(vars.zeff.name, vars.rho, [vars.zeff]),
            PlotData(vars.elong.name, vars.rho, [vars.elong]),
            PlotData(vars.wexb.name, vars.rho, [vars.wexb]),
        ...
        plotdata = [
            ...
            PlotData(vars.betaeu.name, vars.rho, [vars.betaeu]),
            ...
            PlotData(vars.alphamhdu.name, vars.rho, [vars.alphamhdu]),
            PlotData(vars.gmax.name, vars.rho, [vars.gmax]),
            PlotData(vars.gyrfe.name, vars.rho, [vars.gyrfe]),
            PlotData(vars.gyrfeu.name, vars.rho, [vars.gyrfeu]),
            PlotData(vars.gyrfi.name, vars.rho, [vars.gyrfi]),
            PlotData(vars.gyrfiu.name, vars.rho, [vars.gyrfiu]),
