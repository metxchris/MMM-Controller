...
if __name__ == '__main__':
    ...
    v0, options = load_all_rho(runid, vname, 10007, True)  # E 1E6
    ...
    rms02 = load_all_rho_rms(runid, vname, v0, 10009, r'$n_{\rm E} = 100$')
    rms03 = load_all_rho_rms(runid, vname, v0, 10010, r'$n_{\rm E} = 200$')
    rms01 = load_all_rho_rms(runid, vname, v0, 10019, r'$n_{\rm E} = 400$')
    rms04 = load_all_rho_rms(runid, vname, v0, 10012, r'$\overline{n}_{\rm \mathcal{E}} = 26.8$')
    rms05 = load_all_rho_rms(runid, vname, v0, 10018, r'$n_{\rm L} = 1250$')
    rms06 = load_all_rho_rms(runid, vname, v0, 10017, r'$n_{\rm L} = 2500$')
    rms07 = load_all_rho_rms(runid, vname, v0, 10016, r'$n_{\rm L} = 5000$')
    rms11 = load_all_rho_rms(runid, vname, v0, 10021, r'$n_{\rm L} =  500$')
    rms10 = load_all_rho_rms(runid, vname, v0, 10020, r'$n_{\rm L} = 1000$')
    rms08 = load_all_rho_rms(runid, vname, v0, 10014, r'$n_{\rm L} = 2000$')
    rms09 = load_all_rho_rms(runid, vname, v0, 10015, r'$n_{\rm L} = 4000$')
    rms12 = load_all_rho_rms(runid, vname, v0, 10024, r'$n_{\rm \mathcal{E}} = 7\times10$')
    rms13 = load_all_rho_rms(runid, vname, v0, 10023, r'$n_{\rm \mathcal{L}} = 7\times10$')
