...
def get_compared_profiles(ptype, r, scan_nums, legends, savename_append, title=''):
    ...
    if ptype == 'max':
        var_names = ['gmaETGM', 'omgETGM', 'xteETGM', 'xte2ETGM', 'kyrhosETGM', 'gaveETGM', 'phi2ETGM', 'Apara2ETGM', 'satETGM']
...
if __name__ == '__main__':
    ...
    bp = r'$\beta^\prime_\mathrm{e,u}$'


    # COMPARED PROFILES
    # pmax = get_compared_profiles('max', r, [nmax], [''], 'base')
    # psum = get_compared_profiles('sum', r, [nsum], [''], 'base')
    # plot_profiles([pmax, psum], [all_data_max, all_data_sum], autosave=1)
