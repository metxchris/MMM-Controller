...
class FigData:
    ...
    * logx (bool): If the x-axis should be logarithmic
    * logy (bool): If the y-axis should be logarithmic
...
if __name__ == '__main__':
    ...
    fig_data.set(
        ...
        # wexb = 0
        PlotDataCsv(runid='120968A02', xname='rmina', yname='nuei', legend='High', scan_num=50),
        PlotDataCsv(runid='120982A09', xname='rmina', yname='nuei', legend='Low', scan_num=12),
        xmin=0, xmax=0.8, ymin=0.01, logy=True  # ymax=1.6e6,
