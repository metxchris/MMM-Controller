...
if __name__ == '__main__':
    ...
    * Uncomment the line you wish to use
    ...
    num = 27124  # #126 9.1.1 w20 zggev
    # num = 27123  # #126 9.1.1 mtm default
    # num = 27122  # #126 9.1.1 etgm default
    # num = 27121  # #126 9.1.1 dbm default
    # num = 27120  # #126 9.1.1 w20
    ...
    # num = 27111  # #122 v9.1.0 dbm default
